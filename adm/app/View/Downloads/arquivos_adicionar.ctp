                        ...
                        <div class="sttabs tabs-style-line">
                            ...
                            <div class="content-wrap">
                                <section id="section-line-1">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Arquivo: <span class="required">* </span></label>
                                        <div class="col-md-10">
                                            <?php 

                                            echo $this->Form->input('arquivo',array( 'type' => 'file','label' => false, 'div' => false, 'class' => 'filestyle irequired', 'data-buttonName' => 'btn-primary'));
                                            ?>
                                        </div>
                                    </div>
