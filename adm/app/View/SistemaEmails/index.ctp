    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <div class="novo">
                    <a href="emails/adicionar/" class="btn btn-circle btn-default">
                                ...
                                <td rowspan="1" colspan="1">
                                    <div class="margin-bottom-5">
                                        <button class="btn btn-sm yellow filter-submit margin-bottom">
                                            ...
                                            <a href="emails/editar/<?= $value['Contato']['id'] ?>" style="color:#FFF;">Editar</a>
                                        </button>
                                    </div>
                                    <button class="btn btn-sm red filter-cancel">
                                        <i class="fa fa-times"></i>
                                        <a data-href="emails/remover/<?= $value['Contato']['id'] ?>" data-toggle="modal" data-target="#confirm-delete" style="color:#FFF;"> Apagar </a>
                                    </button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
