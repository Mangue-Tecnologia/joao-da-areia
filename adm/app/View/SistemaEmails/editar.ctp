            ...
            <div class="white-box">
                <form action="" method="post">
                    <div class="actions btn-set">
                        <a href="emails" name="back" class="btn btn-default btn-circle"><i class="fa fa-angle-left"></i> Voltar </a>
                                ...
                                <section id="section-line-1">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="email" class="form-control js-maxlength" name="email" required="required" value="<?= $item['Contato']['email'] ?>" maxlength="100" data-always-show="true">
                                            </div>
                                        </div>
                                    </div>
                                </section>
