            ...
            <div class="white-box">
                <form method="post" enctype="multipart/form-data" onsubmit="required();return false;">
                    ...
                    <div class="actions btn-set">
                        <a href="paginas/blog/" name="back" class="btn btn-default btn-circle"><i class="fa fa-angle-left"></i> Voltar </a>
                                ...
                                <section id="section-line-1">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                               <input type="text" class="form-control irequired js-maxlength" name="titulo" maxlength="150" data-always-show="true">
                                           </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control irequired js-tags-input" name="keywords">
                                             </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control js-maxlength" name="descricao_curta" maxlength="180" data-always-show="true"></textarea>
                                             </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control summernote" name="texto"></textarea>
                                            </div>
                                        </div>
