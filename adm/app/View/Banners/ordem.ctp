                                    ...
                                    <div class="form-body">
                                        <ul class="sortable">
                                            ...
                                            foreach ($items as $key => $value) {
                                                echo '<li class="ui-state-default ui-sortable-handle"><input type="hidden" name="ordem[]" value="'.$value['Banners']['id'].'">
                                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span><img src="'.$conf['assets_url'].'img/banners/'.$value['Banners']['imagem'].'" class="img-responsive" style="width:80px;"></img></li>';
                                            }
                                            ?>
                                        </ul>
                                    </div>
