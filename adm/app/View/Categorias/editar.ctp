            ...
            <div class="white-box">
                <form method="post" onsubmit="required();return false;">
                    <div class="actions btn-set">
                        <a href="categorias" name="back" class="btn btn-default btn-circle"><i class="fa fa-angle-left"></i> Voltar </a>
                                ...
                                <section id="section-line-1">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control irequired js-maxlength" name="nome" value="<?= $item['Categorias']['nome'] ?>" maxlength="100" data-always-show="true">
                                            </div>
                                        </div>
                                    </div>
                                </section>
