                                ...
                                <section id="section-line-1">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" class="form-control irequired" name="porcentagem" value="<?= $item['Cupons']['porcentagem'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control irequired" name="status">
                                                    <option value="1" <?=( $item['Cupons']['status'] == 1 ) ? "selected": ""; ?>>Ativado</option>
                                                    <option value="0" <?=( $item['Cupons']['status'] == 0 ) ? "selected": ""; ?>>Desativado</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
