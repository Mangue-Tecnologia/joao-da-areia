            ...
            <div class="white-box">
                <form method="post" enctype="multipart/form-data" onsubmit="required();return false;">
                    ...
                    <div class="actions btn-set">
                        <a href="paginas/parceiros/" name="back" class="btn btn-default btn-circle"><i class="fa fa-angle-left"></i> Voltar </a>
                                    ...
                                    <div class="form-body">
                                        <ul class="sortable">
                                            ...
                                            foreach ($items as $key => $value) {
                                                echo '<li class="ui-state-default ui-sortable-handle"><input type="hidden" name="ordem[]" value="'.$value['Parceiros']['id'].'">
                                                <span class="ui-icon ui-icon-arrowthick-2-n-s"></span><img src="'.$conf['assets_url'].'img/parceiros/'.$value['Parceiros']['imagem'].'" class="img-responsive" style="width:80px;"></img></li>';
                                            }
                                            ?>
                                        </ul>
                                    </div>
