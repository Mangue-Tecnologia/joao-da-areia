                ...
                <form action="" class="form-horizontal form-bordered form-row-stripped js-validation" method="post" enctype="multipart/form-data" onsubmit="return checkFile()">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject font-green-sharp bold uppercase">Editar Evento </span>
                                <span class="caption-helper"><?= $item['AgendaEventos']['titulo'] ?></span>
                            </div>
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                     <input type="text" class="form-control js-maxlength" name="titulo" required="required" maxlength="100" data-always-show="true" value="<?= $item['AgendaEventos']['titulo'] ?>">
                                                 </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" name="dia" required="">
                                                        <option <?= ($item['AgendaEventos']['id_agenda_dia'] == 1) ? "selected=''" : ""; ?> value="1">Quinta, 12/10/17</option>
                                                        <option <?= ($item['AgendaEventos']['id_agenda_dia'] == 2) ? "selected=''" : ""; ?> value="2">Sexta, 13/10/17</option>
                                                        <option <?= ($item['AgendaEventos']['id_agenda_dia'] == 3) ? "selected=''" : ""; ?> value="3">Sábado, 14/10/17</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="time" class="form-control js-maxlength" name="horario" maxlength="100" data-always-show="true" required="required" value="<?= $item['AgendaEventos']['horario'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control js-maxlength" name="descricao_curta" maxlength="100" data-always-show="true" required="required" value="<?= $item['AgendaEventos']['descricao_curta'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                     <input type="text" class="form-control js-maxlength" name="nome" required="required" maxlength="100" data-always-show="true" value="<?= $item['AgendaEventos']['nome'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control js-maxlength" name="apoio" maxlength="100" data-always-show="true" required="required" value="<?= $item['AgendaEventos']['apoio'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control js-maxlength" name="local" maxlength="100" data-always-show="true" required="required" value="<?= $item['AgendaEventos']['local'] ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control js-maxlength ckeditor" maxlength="5000" data-always-show="true" name="texto"><?= $item['AgendaEventos']['texto'] ?></textarea>
                                                 </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="tab_images">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <img id="preview" src="<?= $conf['assets_url'].'img/agenda/'.$item['AgendaEventos']['imagem'] ?>" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
