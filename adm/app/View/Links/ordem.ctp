                                    ...
                                    <div class="form-body">
                                        <ul class="sortable">
                                            ...
                                            foreach ($items as $key => $value) {
                                                echo '<li class="ui-state-default ui-sortable-handle"><input type="hidden" name="ordem[]" value="'.$value['Links']['id'].'"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>'.$value['Links']['nome'].'</li>';
                                            }
                                            ?>
                                        </ul>
                                    </div>
