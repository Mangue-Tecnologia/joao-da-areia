    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> <a href="<?= $conf['site_url']; ?>" target="_blank" class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Ver Site</a>
        	<ol class="breadcrumb">
                ...
                <li><a href="/produtos/loja_virtual">Produtos / loja virtual</a></li>
                                ...
                                <section id="section-line-1">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control irequired valid" name="preco" data-mask="#.##0,00" data-mask-reverse="true" autocomplete="off" aria-required="true" aria-invalid="false">
                                            </div>
                                        </div>
