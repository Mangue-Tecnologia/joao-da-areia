    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> <a href="<?= $conf['site_url']; ?>" target="_blank" class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Ver Site</a>
            <ol class="breadcrumb">
                ...
                <li><a href="/produtos/loja_virtual">Loja virtual</a></li>
            ...
            <div class="white-box">
                <form method="post" enctype="multipart/form-data" onsubmit="required();return false;">
                    ...
                    <div class="actions btn-set">
                        <a href="produtos/loja_virtual/" name="back" class="btn btn-default btn-circle"><i class="fa fa-angle-left"></i> Voltar </a>
                                ...
                                <section id="section-line-1">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control irequired subcategoria" name="subcategoria" onchange="buscar_subcategorias(this.value)">
                                                    <?php 
                                                        foreach ($subcategorias as $key=> $value) { 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control irequired js-maxlength" name="codigo" maxlength="50" data-always-show="true" value="<?= $item['Produtos']['codigo'];?>">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Preço: <span class="required">* </span></label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control irequired valid" name="preco" data-mask="#.##0,00" data-mask-reverse="true" autocomplete="off" aria-required="true" aria-invalid="false" value="<?= $item['Produtos']['preco'];?>">
                                            </div>
                                        </div>
