<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <div class="titulo">
                    <h3 class="box-title m-b-0">Orçamento</h3>
                    <p class="text-muted m-b-30">Lista de produtos só para orçamento</p>
                </div>
                <div class="novo">
                    <a href="produtos/orcamento/adicionar/" class="btn btn-circle btn-default">
                            ...
                            <tr role="row" class="filter">
                                ...
                                <td rowspan="1" colspan="1">
                                    <div class="margin-bottom-5">
                                        <a class="btn btn-sm yellow filter-submit margin-bottom" style="color:#FFF;font-size: 12px;" href="produtos/orcamento/editar/<?= $value['Produtos']['id'] ?>">
                                            <i class="fa fa-pencil"></i> Editar
                                        </a>
                                    </div>
                                    <div class="margin-bottom-5">
                                        <a class="btn btn-sm red filter-cancel" data-href="produtos/orcamento/remover/<?= $value['Produtos']['id'] ?>" data-toggle="modal" data-target="#confirm-delete" style="color:#FFF;font-size: 12px;">
