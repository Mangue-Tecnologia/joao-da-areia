<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <div class="titulo">
                    <h3 class="box-title m-b-0">Promoções</h3>
                    <p class="text-muted m-b-30">Lista de imagens</p>
                </div>
                <div class="novo">
                    <a href="promos/adicionar/" class="btn btn-circle btn-default">
                    ...
                    <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="filter">
                                ...
                                <td rowspan="1" colspan="1">
                                    <a href="<?= $conf['assets_url'].'img/promos/'.$value['Promos']['imagem'] ?>" class="fancybox">
                                        <img src="<?= $conf['assets_url'].'img/promos/'.$value['Promos']['imagem'] ?>" class="img-responsive" style="width:80px;"></img>
                                    </a>
                                </td>
                                <td rowspan="1" colspan="1">
                                    <?php
                                    if ($value['Promos']['status'] == 1) {
                                ...
                                <td rowspan="1" colspan="1">
                                    <div class="margin-bottom-5">
                                        <button class="btn btn-sm yellow filter-submit margin-bottom">
                                            ...
                                            <a href="promos/editar/<?= $value['Promos']['id'] ?>" style="color:#FFF;">Editar</a>
                                        </button>
                                    </div>
                                    <button class="btn btn-sm red filter-cancel">
                                        <i class="fa fa-times"></i>
                                        <a data-href="promos/remover/<?= $value['Promos']['id'] ?>" data-toggle="modal" data-target="#confirm-delete" style="color:#FFF;"> Apagar </a>
                                    </button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
