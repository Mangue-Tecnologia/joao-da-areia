                                ...
                                <section id="section-line-1">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control js-maxlength" name="titulo" required="required" maxlength="100" data-always-show="true" value="<?= $item['Promos']['titulo'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" name="status">
                                                    <option value="1" <?=( $item['Promos']['status'] == 1 ) ? "selected": ""; ?>>Ativado</option>
                                                    <option value="0" <?=( $item['Promos']['status'] == 0 ) ? "selected": ""; ?>>Desativado</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control js-maxlength" name="link" maxlength="50" data-always-show="true" value="<?= $item['Promos']['link'];?>">
                                            </div>
                                        </div>
