<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Vendedores</h4> </div>
            ...
            <div class="white-box">
                <form method="post" enctype="multipart/form-data" onsubmit="required();return false;">
                    ...
                    <div class="actions btn-set">
                        <a href="vendedores/" name="back" class="btn btn-default btn-circle"><i class="fa fa-angle-left"></i> Voltar </a>
                                ...
                                <section id="section-line-1">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control irequired js-maxlength" name="nome" maxlength="140" data-always-show="true" value="<?= $item['Vendedores']['nome']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control irequired js-maxlength" name="email" maxlength="140" data-always-show="true" value="<?= $item['Vendedores']['email']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control irequired" name="cpf" data-mask="000.000.000-00" value="<?= $item['Vendedores']['cpf']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control irequired" name="status">
                                                    <option value="1" <?=( $item['Vendedores']['status'] == 1 ) ? "selected": ""; ?>>Ativo</option>
                                                    <option value="0" <?=( $item['Vendedores']['status'] == 0 ) ? "selected": ""; ?>>Desativado</option>
                                                </select>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Mostrar no site: <span class="required">* </span></label>
                                            <div class="col-md-10">
                                                <select class="form-control irequired" name="mostrar_site">
                                                    <option value="1" <?=( $item['Vendedores']['mostrar_site'] == 1 ) ? "selected": ""; ?>>Sim</option>
                                                    <option value="0" <?=( $item['Vendedores']['mostrar_site'] == 0 ) ? "selected": ""; ?>>Não</option>
                                                </select>
                                            </div>
                                        </div>
