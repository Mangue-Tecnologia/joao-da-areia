                                ...
                                <section id="section-line-1">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Código de rastreio: <span class="required">* </span>
                                            </label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control js-maxlength" name="codigo_rastreio" required="required" value="<?= $item['Pedidos']['codigo_rastreio'] ?>" maxlength="100" data-always-show="true">
                                            </div>
                                        </div>
                                    </div>
                                </section>
